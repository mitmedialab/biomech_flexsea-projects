...
GainParams ankleGainsEst = {3.5, 0.0, 0.15, 0.0};	// may want to increase this damping, at least.
GainParams ankleGainsMst = {3.5, 0.0, 0.15, 0.0};	// may want to increase this damping, at least.
GainParams ankleGainsLst = {4.0, 0.0, 0.15, 1.0};
GainParams ankleGainsEsw = {1.0, 0.0, 0.15, 0.0};
GainParams ankleGainsLsw = {1.0, 0.0, 0.15, 0.0};
