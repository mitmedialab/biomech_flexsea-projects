...
// 				}
				...
				//f = 15
				float feats1[] = {-2.656109, -0.849971, -1.486517, -0.434396, 0.395582, -1.073421, 0.313268, -0.050407, -0.166530, -0.008023, 0.263814, -1.089150, -0.527723, -1.476030, 0.074912};
				float feats2[] = {0.352988, -0.679438, -0.065309, 2.051041, 0.423754, -0.698510, -1.541818, 0.793018, -0.854005, 0.126340, 0.102898, -0.326787, -1.407863, -0.483258, 0.056300};
				float feats3[] = {0.131655, -1.428677, 0.328700, 0.760784, -0.196454, -0.231019, -0.054043, 0.743880, -0.661904, 0.137119, 1.234024, -1.627509, -0.466042, -0.640547, -1.959847};
			...
			rigid1.mn.genVar[1] = (int16_t) (indicator); //
			 rigid1.mn.genVar[2] = (int16_t) (tm.lda.A[68]*1000.0); //
			 rigid1.mn.genVar[3] = (int16_t) (tm.lda.A[69]*1000.0); //
			 rigid1.mn.genVar[4] = (int16_t) (tm.lda.A[70]*1000.0); //
			  rigid1.mn.genVar[5] = (int16_t) (tm.lda.A[71]*1000.0); //
			  rigid1.mn.genVar[6] = (int16_t) (tm.lda.A[72]*1000.0);//
			  rigid1.mn.genVar[7] = (int16_t) (tm.lda.A[73]*1000.0);//
			  rigid1.mn.genVar[8] = (int16_t) (tm.lda.A[74]*1000.0);//
		   	rigid1.mn.genVar[9] = (int16_t) (tm.lda.B[4]*1000.0);//
