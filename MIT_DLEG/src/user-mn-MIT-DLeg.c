...
// 				}
			...
			rigid1.mn.genVar[1] = (int16_t) (status); //
			 rigid1.mn.genVar[2] = (int16_t) (indicator); //
			 rigid1.mn.genVar[3] = (int16_t) (tm.lrn.LT[0]*1000.0); //
			 rigid1.mn.genVar[4] = (int16_t) (tm.lrn.LT[6]*1000.0); //
			  rigid1.mn.genVar[5] = (int16_t) (tm.lrn.LT[12]*1000.0); //
			  rigid1.mn.genVar[6] = (int16_t) (tm.lrn.LT[18]*1000.0);//
			  rigid1.mn.genVar[7] = (int16_t) (tm.lrn.LT[24]*1000.0);//
			  rigid1.mn.genVar[8] = (int16_t) (tm.lrn.LT[15]*1000.0);//
		   	rigid1.mn.genVar[9] = (int16_t) (tm.lrn.LT[20]*1000.0);//
