...
static void initializeUserWrites(Act_s *actx, WalkParams *wParams){
	...
	wParams->virtualHardstopK				= 15.0;	//user_data_1.w[2] = 1800 [Nm/deg] NOTE: Everett liked this high, Others prefer more like 6.0
	wParams->lspEngagementTorque 			= 70.0;	//user_data_1.w[3] = 7400 [Nm]
	wParams->lstPGDelTics 					= 50.0;	//user_data_1.w[4] = 30
	lstPowerGains.k1						= 5.0;	//user_data_1.w[5] = 100 [Nm/deg]
	lstPowerGains.thetaDes 					= 18;	//user_data_1.w[6] = 2200 [Deg]
	lstPowerGains.b		 					= 0.15;	//user_data_1.w[7] = 30   [Nm/s]
	estGains.k1			 					= 1.5;	//user_data_1.w[8] = 200  [Nm/deg]
	estGains.b			 					= 0.2;	//user_data_1.w[9] = 320  [Nm/s]
