...
//Call this function in one of the main while time slots.RCE_MAX_TICKS;
...
//			    	sineDemo(3/2*M_PI+0.563, 0.25, 15, 8);
			    	act1.tauDes = biomCalcImpedance(1, 0, 0.1, 0);
...
//	}
	...
	torqueDes = biomCalcImpedance(1.5, 0, 0.1, thetaSet);
