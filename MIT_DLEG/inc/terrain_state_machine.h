...
#define DEFAULT_URAMP_EST_LST_MIN_THETA_RAD 0.05
...
#define DEFAULT_DRAMP_EST_LST_MIN_THETA_RAD 0.05
...
#define DEFAULT_USTAIRS_LST_K_NM_P_RAD 10.0
#define DEFAULT_USTAIRS_LST_B_NM_P_RPS 0.0
#define DEFAULT_USTAIRS_LST_THETA_RAD 0.0
#define DEFAULT_USTAIRS_EST_LST_MIN_THETA_RAD 0.05

#define DEFAULT_DSTAIRS_HS_THETA_RAD -0.1
...
#define DEFAULT_DSTAIRS_EST_B_NM_P_RPS 1.0
