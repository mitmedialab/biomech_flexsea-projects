...
#define DEFAULT_NOMINAL_K_NM_P_RAD 10.0
...
#define DEFAULT_FLAT_LST_K_NM_P_RAD 500.0
#define DEFAULT_FLAT_LST_B_NM_P_RPS 5.0
...
#define DEFAULT_DSTAIRS_LSW_THETA_RAD 0.20
#define DEFAULT_DSTAIRS_EST_K_NM_P_RAD 0.0
#define DEFAULT_DSTAIRS_EST_B_NM_P_RPS 0.0
#define DEFAULT_DSTAIRS_LST_K_NM_P_RAD 100.0
#define DEFAULT_DSTAIRS_LST_B_NM_P_RPS 0.0
#define DEFAULT_DSTAIRS_LST_THETA_RAD -0.4
#define DEFAULT_DSTAIRS_LST_ENGAGEMENT_TQ_NM 20.0
