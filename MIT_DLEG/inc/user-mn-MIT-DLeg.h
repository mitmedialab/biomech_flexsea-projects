...
enum Gui_Modes {
	...
	GUI_MODE_TASK_MACHINE = 17,
	GUI_MODE_STATISTICS = 18,
	GUI_MODE_PREDICTOR = 19,
	GUI_MODE_STATISTICS_SIMPLE = 20,
	GUI_MODE_EXPERIMENTAL = 21,
	GUI_MODE_ACCURACY_1 = 22,
	GUI_MODE_ACCURACY_2 = 23,
	GUI_MODE_BACK_ESTIMATION1 = 24,
	GUI_MODE_BACK_ESTIMATION2 = 25,
};
